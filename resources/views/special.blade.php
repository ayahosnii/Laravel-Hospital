                                    ...
                                    <div id="grid-container" class="cbp-l-grid-team">
                                        <ul>
                                            ...
                                            <li class="cbp-item Cardiologist">
                                                <a href="{{url('specializations/'.$specialization->id)}}" class="cbp-caption">
                                                    <div class="cbp-caption-defaultWrap">
                                                        <img src="img\sp.png" alt="" width="100%">
                                                    </div>

                                                    <div class="cbp-caption-activeWrap">
                                                        <div class="cbp-l-caption-alignCenter">
                                                            <div class="cbp-l-caption-body">
                                                                <div class="cbp-l-caption-text">VIEW DOCTORS</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </a>
                                                <div class="cbp-l-grid-team-position">{{$specialization->name}}</div>
                                                @endforeach
                                                @endif
