                ...
                <div class="col-xs-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form action="{{route('admin.languages.store')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input name="name" type="text" class="form-control" placeholder="Language Name">
                                    </div>
                                    <label for="doctorName" class="col-md-2 col-sm-2 control-label">Language Abbr</label>
                                    <div class="col-md-4">
                                        <input name="abbr" type="text" class="form-control" placeholder="Language Abbr">
                                    </div>
                                    </div>
                                <div class="form-group">
