        ...
        <section class="content">
            <section class="content-header">
                ...
                <ol class="breadcrumb breadcrumb-sm">
                    ...
                    <li class="active">Add new specializations</li>
                </ol>
            </section>
                ...
                <div class="col-xs-12">
                    <section class="panel">
                        <header class="panel-heading">
                            <i class="fa fa-hdd-o fa-fw" aria-hidden="true"></i> New specializations
                        </header>
                        <div class="panel-body">
                            <form action="{{route('save.services')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                @csrf

                                <div class="form-group">
                                    <label for="photo" class="col-md-2 col-sm-2 control-label">Choose Doctor</label>
                                    <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        <label for="photo" class="col-md-2 col-sm-2 control-label">Choose Specialzation</label>
                                        <div class="col-md-10">
                                            <br>
